...
$(function () {
  ...
  // Evitar llamadas directas a PerfectScrollbar (causaban ReferenceError si no estaba cargado)
  function initPerfectScrollbar() {
    try {
      if (typeof PerfectScrollbar === "function") {
        ...
        var headerMessageList = document.querySelector(".header-message-list");
        if (headerMessageList) {
          new PerfectScrollbar(headerMessageList);
        }

        var headerNotificationsList = document.querySelector(
      ...
      console.warn("PerfectScrollbar init skipped:", err);
    }
  }

  // handlers y lógica existente (sin cambios funcionales)
  ...
  // Inicializar PerfectScrollbar de forma segura (si la librería está cargada)
